...
import { useOnClickOutside } from '../../app-redux/hooks/useOnClickOutside';
...
const AutoComplete = ( props ) => {
    ...
    const renderUngroupedSuggestions = () => {
      ...
      if (sortSingleData.length) {
        ...
        console.log('test the no result data...')
        return (
  ...
  return (
         <>
         <div className="search_input_wrapper d-flex">
              <InputGroup className="input_wrapper">
              <InputGroupText className='search_icon'>
                ...
                <Input type="text" onChange={e => {
                  ...
                  <div className="search-input-close mt-1">
                    <Icon
                      width="24"
                      height="24"
                      icon="material-symbols:close"
                      onClick={() => {
                        props.setNavbarSearch(false);
                      }}
                    />
                  </div>
              </InputGroup>
